...
export class CoordinateMapper {
  ...
  convertBoxPreviewToOriginal(previewBox) {
    ...
    return {
      ...
      borderWidth: previewBox.borderWidth * this.scaleRatio.x,
      borderRadius: previewBox.borderRadius * this.scaleRatio.x
    }
  }
  ...
  convertBoxOriginalToPreview(originalBox) {
    ...
    return {
      ...
      borderWidth: originalBox.borderWidth / this.scaleRatio.x,
      borderRadius: originalBox.borderRadius / this.scaleRatio.x
    }
  }
